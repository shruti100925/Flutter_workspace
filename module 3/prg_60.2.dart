          ...
          child: Column(
            children: [
              ...
              Row(
                ...
                children: [
                  IngredientChip(
                      label: 'Noodle', iconPath: 'images/ingre1.png'),
                  IngredientChip(
                      label: 'Shrimp', iconPath: 'images/ingre2.png'),
                  IngredientChip(label: 'Egg', iconPath: 'images/ingre3.png'),
                  IngredientChip(
                      label: 'Scallion', iconPath: 'images/ingre4.png'),
                ],
              ),
              Column(
                children: [
